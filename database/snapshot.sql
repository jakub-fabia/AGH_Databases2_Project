...
1	1	<< Flyway Baseline >>	BASELINE	<< Flyway Baseline >>	\N	booking_user	2025-06-17 19:39:56.680399	0	t
\.
...
SELECT pg_catalog.setval('public.booking_booking_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.booking_log_booking_log_id_seq', 31, true);
...
SELECT pg_catalog.setval('public.booking_room_booking_room_id_seq', 58, true);
...
SELECT pg_catalog.setval('public.guest_guest_id_seq', 16, false);
...
SELECT pg_catalog.setval('public.hotel_hotel_id_seq', 7, false);
...
SELECT pg_catalog.setval('public.room_room_id_seq', 31, false);
...
SELECT pg_catalog.setval('public.room_type_room_type_id_seq', 5, false);
